...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="resources/js/barhierarchy/style.css"/>
    <style type="text/css">
...
d3.csv("resources/csv/barhierarchy.csv", function(error, temp) {
	
	  var data = d3.nest()
    .key(function(d) { return d.name; })
		  .key(function(d) { return d.childr; })
		  .key(function(d) { return d.chi; })
		  .key(function(d) { return d.c; })
		  .key(function(d) { return d.children; })
        .entries(temp);
