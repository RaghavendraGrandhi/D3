...
<body class="bg-gradient-primary">
	...
	<script src="../resources/js/live-data-mapping/coffee-wheel-advanced.js"></script>
	<script src="../resources/js/live-data-mapping/live-data-map-advanced.js"></script>
