var dashboard, level1, level = 0,consolidateData = [],fieldNames = [],worksheet,home_url, visualization_code,columnHierarchial=[],app_url,start,end;
...
function switchVisualization(visualization_code,list,properties) {
	
	$(".visualization").css("display", "none");
	
	switch (visualization_code) {
	case "1":
