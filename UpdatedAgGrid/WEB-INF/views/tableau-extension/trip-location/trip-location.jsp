...
<head>
  ...
  <link href='../resources/css/trip-location/main.css' rel='stylesheet' type='text/css'>
</head>
<body>
  ...
  <div class="full-width header">
    ...
    <div class="container section-share text-right">
      ...
      var addthis_share = {"url":"http://mbtaviz.github.io/","title":"Visualizing MBTA Data","description":"An interactive exploration of Boston's subway system"};
      </script>
      <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5253f5637952ccec"></script>
      <iframe src="http://ghbtns.com/github-btn.html?user=mbtaviz&repo=mbtaviz.github.io&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="90px" height="20px"></iframe>
    </div>
    <!-- AddThis Button END -->
  </div>
  ...
  <script src="../resources/js/tableau-extension/trip-location/es6-shim.min.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/underscore.min.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/moment.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/d3.min.js"></script>
  <script src="../resources/js//jquery-2.2.4.min.js"></script>

  <!-- D3 Plugins -->
  <script src="../resources/js/tableau-extension/trip-location/horizon.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/index.js"></script> 

  <!-- Custom Code -->
  <script src="../resources/js/tableau-extension/trip-location/common.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/files.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/dataloader.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/fixed.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/header.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/the-trains.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/the-people.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/congestion-and-delay.js"></script>
  <script src="../resources/js/tableau-extension/trip-location/your-commute.js"></script>
  
    <script src="../resources/js/tableau-extension/trip-location/signet.min.js"></script>
