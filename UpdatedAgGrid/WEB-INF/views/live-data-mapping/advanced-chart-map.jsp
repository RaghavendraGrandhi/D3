...
<body class="bg-gradient-primary">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div id="advancedChartDivContent">
								<div >
									<h1 class="h4 text-gray-900 mb-4" style="color: white!important;">Advanced Charts</h1>
								</div>
			...
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="container">
						...
						<div class="row">
							<div class=" col-md-4 ">
								<label>Select Field:</label> <select id="optgroup"
	...
	<div style="padding: 10px" class=" " id="agGridView">
		<div class="alert alert-primary" role="alert"
			...
			Please click the download button <a href="" target="_blank"
				class="btn btn-success" onClick="hideLinkAdvanced()" id="excelDownload">download</a>
		</div>
 ...
 <script src="../resources/js/ag-grid/ag-grid-enterprise.min.noStyle.js"></script>
	...
	<script src="../resources/js/live-data-mapping/coffee-wheel-ads.js"></script>
	<script src="../resources/js/live-data-mapping/live-data-mapping-ads.js"></script>
