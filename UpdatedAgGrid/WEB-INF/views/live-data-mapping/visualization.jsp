...
<script
	src="../../resources/js/ag-grid/ag-grid-enterprise.min.noStyle.js"></script>
...
<script type="text/javascript"
	src="../../resources/js/live-data-mapping/visualization.js"></script>
<style>
.disable-element {
			...
			<div id="content">
					...
					<!-- <ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-800 large">StratApps</span>
				...
				<div class="container-fluid">
					...
					<div
						...
						<button type="button" class="btn btn-success mt-2 pl-3 pr-3" onClick="tableau.extensions.ui.closeDialog(2)">Back</button>
					</div>
					...
					<div class="row">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(1)" href="#data-section">
											
											<img src="../../resources/images/gif/Ag-grid.gif"
						...
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Coffee Wheel View</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"> <i
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(2)" href="#data-section">
											<img src="../../resources/images/gif/Coffee-wheel.gif"
						...
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Hierarchial Edge Bundling View</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"> <i
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(3)" href="#data-section">
											<img src="../../resources/images/gif/hirachial.gif"
												alt="Nature" style="width: 100%;">
...
<!-- Concept Map -->
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Concept Map View</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"> <i
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(4)" href="#data-section">
											<img src="../../resources/images/gif/concept-map.gif"
												alt="Nature" style="width: 100%;max-height: 180px">
						...
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(5)" href="#data-section">
											<img src="../../resources/images/gif/tree-map.gif"
												alt="Nature" style="width: 100%;max-height: 180px">
						...
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(6)" href="#data-section">
											<img src="../../resources/images/gif/bar-chart.PNG"
												alt="Nature" style="width: 100%;max-height: 180px">
						...
						<div class="col-xl-3 col-lg-6">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<div class="chart-area">
										<a class="thumbnail" onclick="switchVisualization(7)" href="#data-section">
											<img src="../../resources/images/gif/pie-chart.PNG"
												alt="Nature" style="width: 100%;max-height: 180px">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<button type="button" data-toggle="collapse"
										...
										class="btn btn-primary mt-2" onClick="addField()" id="addFieldButton">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-7 col-lg-7 pt-2">
											<div class="custom-control custom-radio pt-2">
												...
												<label class="custom-control-label"
													for="customControlValidation2">Same values have the
													same colors</label>
											</div>
											<div class="custom-control custom-radio pt-2">
											...
											<div class="custom-control custom-radio pt-2">
												<input type="radio" class="custom-control-input"
													id="customControlValidation4" name="radio-stacked" required>
												<label class="custom-control-label"
										...
										<div class="col-md-7 col-lg-7 pt-2">
											<div class="custom-control custom-radio pt-2">
												<input type="radio" class="custom-control-input checked"
													id="customControlValidation5" name="radio-stacked" required>
												<label class="custom-control-label"
											...
											<div class="custom-control custom-radio pt-2">
												<input type="radio" class="custom-control-input"
													id="customControlValidation6" name="radio-stacked" required>
												<label class="custom-control-label"
													for="customControlValidation6">Input</label>
											</div>
											<div class="custom-control custom-radio pt-2">
												<input type="radio" class="custom-control-input"
													id="customControlValidation7" name="radio-stacked" required>
												<label class="custom-control-label"
													for="customControlValidation7">Output</label>
											</div>
											<div class="custom-control custom-radio pt-2">
												<input type="radio" class="custom-control-input"
													id="customControlValidation8" name="radio-stacked" required>
												<label class="custom-control-label"
									...
									<div class="col-md-12" id="metric-body">
										...
										<div class="row">
											...
											<div class="col-md-4 col-lg-4 pt-2 ">
												<label>Measure</label> <select
													class="form-control field-metric" id="measure-field">

												</select>
											</div>
											<div class="col-md-4 col-lg-4 pt-3 ">
												<label></label> <select class="form-control calculation"
													id="metric1"  height: 32px">
											...
											<div class="col-md-2 col-lg-2 pt-4 mt-2">
												<label></label>
												<button type="button" data-toggle="collapse"
													class="btn btn-primary mt-2 remove-metric">
													<i class="fa fa-times-circle"></i>
												</button>
											</div>
											<!-- <div class="col-md-2 col-lg-2 pt-3 mt-4 ">

												<span class="badge badge1 p-2 mr-2">Emp&nbsp;<i
													class="fa fa-times-circle danger"></i></span>
											</div> -->
										</div>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-8 col-lg-8 pt-3">
											<label> click refresh to retrive the latest features!
												Refresh will reset your column, measure and color palette.</label>
										</div>
										<div class="col-md-4 col-lg-4 pt-2">
								...
								<div class="card-header py-3">
									<div class="row text-center">
										...
										<div class="col-md-5 col-lg-5 text-right">
											...
											<button type="button" class="btn btn-info mt-2 pl-3 pr-3" id="closeButton">Ok</button>
										</div>
									</div>
