...
<script
	src="../../resources/js/tableau-extension/coffeeWheel/coffeeWheel-dialog.js"></script>
<script>
	$(document)
			.ready(
					function() {
	...
	<div class="container" style="align-content: center; margin-top: 100px">
		...
		<div class="row " >
			<div class="col-sm-10 fieldDiv" >
				...
				<select name="level3" class="form-control" id="level3" style="margin: 5px">

				</select>
				<select name="level4" class="form-control" id="level4" style="margin: 5px">

				</select>
				<select name="level5" class="form-control" id="level5" style="margin: 5px">
