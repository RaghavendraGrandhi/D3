...
function innerJoin(list1,list2,c1,c2,columns_fields){
	...
	data1= d3.nest()
	  ...
	  .entries(constructObject(data))
	constructArray(data,3,"avg");
	processData(data,data1);
}
function constructArray(data,index,operation){
	$.ajax({
        //url: "https://peoples.io/trinetlive3/upload/live-data-mapping",
        url: "http://localhost:9999/trinetlive/extractData",
        type: 'POST',
