...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/webvowl/webvowl.css" />
    <link rel="stylesheet" type="text/css" href="resources/css/webvowl/webvowl.app.css" />
...
<body>
            ...
            <ul id="optionsMenu">
                <li id="aboutMenu"><a href="#">About</a>
                    <ul class="toolTipMenu aboutMenu">
                        ...
                        <li><a href="https://vowl.visualdataweb.org/webvowl.html#releases" target="_blank">Version: 1.0.6<br/>(release history)</a></li>

                        <li><a href="https://purl.org/vowl/" target="_blank">VOWL Specification &raquo;</a></li>
                    </ul>
                </li>
    ...
    <script src="resources/js/webvowl/webvowl.js"></script>
    <script src="resources/js/webvowl/webvowl.app.js"></script>
    <script>
