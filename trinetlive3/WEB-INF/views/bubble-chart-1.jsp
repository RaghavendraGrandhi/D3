...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-10">
			<div id="mainBubble" style="height: 724px;"><svg class="mainBubbleSVG" width="1033.6" height="724"><text id="bubbleItemNote" x="10" y="501.79999999999995" font-size="12" dominant-baseline="middle" alignment-baseline="middle" style="fill: rgb(136, 136, 136);"></text></svg></div>		
		</div>
	</div>
</div>
  ...
  <script>
   ...
   var mainNote = svg.append("text")
    ...
    d3.json("readFile/main_bubble", function(error, root) {
        console.log(error);
