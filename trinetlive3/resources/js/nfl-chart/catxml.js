...
function Character(char_xml) {
    ...
    //console.log('xml name ' + this.name);
    this.id = parseInt(char_xml.getAttribute("id"));
    this.group = parseInt(char_xml.getAttribute("group"));
    this.order = parseInt(char_xml.getAttribute("order"));
    this.trajectory = parseInt(char_xml.getAttribute("trajectory"));
    this.skills = char_xml.getAttribute("skills").split(" ");
}
