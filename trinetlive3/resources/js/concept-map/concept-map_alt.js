var ConceptMap = function(chartElementId, infoElementId, dataJson) {
    ...
    function G(Y, X) {// console.log(T.get("level1"))
        ...
        L.node = Y;
        // console.log(Y.canonicalKey)
        
       // j.get(Y.canonicalKey);
       // if(Y.depth != 2){
...
//    	if(ac.name === Y.name){
//    		
//    		L.node.children = L.node.children.splice(i,1);
//    	}
//    	icount++;
//    });
        ...
        L.node.children.forEach(function(ac) {
            ...
            // console.log(Object.values(ac.s_children))
        ...
        L.node.children.forEach(function(aa) {
            aa.children = Z > 100 ? aa._group : aa._children
        });
    ...
    function C(Z) {
        ...
        if (ab && ab.type === "ditem") {
            /*
			 * var aa = Y.append("a").attr("xlink:href", function(ae) { return
			 * "/" + ae.slug });
			 */
