...
var q = queue()
    .defer(d3.json, "https://eyeseast.github.io/visible-data/data/gis/us-counties.json")
    .defer(d3.json, "https://eyeseast.github.io/visible-data/data/gis/us-states.json")
    .await(ready);
