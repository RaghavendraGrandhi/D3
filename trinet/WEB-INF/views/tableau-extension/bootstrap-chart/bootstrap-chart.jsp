			...
			.ready(
				function () {
					$("button").click(function(){
						...
						switch ($(this).text()) {
						case "SONGS CHART":
							$("#chart").append('<iframe src="https://peoples.io/trinetlive2/songs-chart" class="animated slideInDown" width="660" height="270"></iframe>')
							break;
						case "BAR HIERARCHY":
							$("#chart").append('<iframe src="https://peoples.io/trinetlive2/barhierarchy" class="animated slideInLeft" width="660" height="270"></iframe>')
							break;
						case "CODE FLOWER":
							$("#chart").append('<iframe src="https://peoples.io/trinetlive2/code-flower" class="animated slideInRight" width="660" height="270"></iframe>')
							break;
						case "DEPARTMENTS":
							$("#chart").append('<iframe src="https://peoples.io/trinetlive2/departments" class="animated slideInUp" width="660" height="270"></iframe>')
							break;
