...
<head>
    ...
    <meta property="og:image" content="httpss://www.brightpointinc.com/interactive/images/Deficit_202px.png">
...
<div id="bpg">
    ...
    <!--[if IE 6]>
    <div id="bpg-error">
        <p>1 This interactive graphic requires a browser with SVG support, such as <a href="httpss://www.google.com/chrome">Chrome</a>, <a href="httpss://www.mozilla.org/en-US/firefox/">Firefox</a>, <a href="httpss://www.apple.com/safari/download/">Safari</a> or the latest <a href="httpss://windows.microsoft.com/en-US/internet-explorer/products/ie/home">Internet Explorer 9</a>. </p>
    ...
    <script type="text/javascript" src="resources/js/trade/data.js"></script>
