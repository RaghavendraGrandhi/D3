...
! function() {
    ...
    function d3_selection_onListener(listener, argumentz) {
        return function(e) {
            ...
            if(argumentz.length){
            	console.log(e)
            	if(!is_globe && e.type == "click"){
            		
            		d3.select(".tableWrapper").style("display","block");
            		d3.select("#tableauViz").style("display","block");
            		d3.select("#video_render").remove();
            	}
            }
            try {
                listener.apply(this, argumentz,checkEvent(d3.event,argumentz))
            } finally {
                d3.event = o
            }
        }
    }
    //Custom event checking
    function checkEvent(e,argumentz){
    	d3.select("#tobpar").classed("active")
//        	if(e.type === "click" ){
//        		if(!d3.select("#tobpar").classed("active"))
//        		alert("Expanding")
//        		else
//        			alert("Clicked")
//        		//console.log(argumentz[0])
//        		
//        	}
    }
...
(function(win, doc) {
    ...
    data.groups = [{
        label: "A",
        teams: ["Texas", "Kansas", "Vermont", "Wisconsin"]
    }, {
        label: "B",
        teams: ["Virginia", "Tennessee", "Oklahoma", "Oregon"]
    },{
        label: "C",
        teams: ["Indiana", "Illinois", "Kentucky", "Louisiana"]
    },{
        label: "D",
        teams: ["Hawaii", "Georgia", "Florida", "Delaware"]
    }];
    data.worldmap = {
        type: "Topology",
        objects: {
    ...
    data.services=[
    	{
            ...
            sublabel: "Incoming Incidents"
    	},{
    		name: "Incoming Problems",
            label: "Incoming Problems",
            sublabel: "Incoming Problems"
    	},{
    		name: "Open Cases ",
            label: "Open Cases ",
            sublabel: "Open Cases "
    	},{
    		name: "Selected / Renewed",
            label: "Clients Benefits",
            sublabel: "Selected / Renewed"
    	},{
    		name: "WSEs Benefits Selected / Renewed",
            label: "WSEs Benefits",
            sublabel: "Selected / Renewed"
    	},{
    		name: "Clients Terminated",
            label: "Clients Terminated",
            sublabel: "Clients Terminated"
    	},{
    		name: "WSEs Terminated",
            label: "WSEs Terminated",
            sublabel: "WSEs Terminated"
    	},{
    		name: "Changes deployed to Production",
            label: "Changes",
            sublabel: "deployed to Production"
    	},{
    		name: "Patching / PW Changes - y/n?",
            label: "Patching",
            sublabel: "Patching/PW Changes - y/n?"
    	},{
    		name: "Sev 1's",
            label: "Sev 1's",
            sublabel: "Sev 1's"
    		...
    		name: "Open Problems ",
            label: "Open Problems ",
            sublabel: "Open Problems "
    	},{
    		name: "Code Release # Jiras",
            label: "Code",
            sublabel: "Code Release # Jiras"
    	},{
    		name: "New Clients Onboarded",
            label: "New Clients",
            sublabel: "New Clients Onboarded     "
    	},{
    		name: "New WSEs onboarded",
            label: "New WSEs",
            sublabel: "New WSEs onboarded"
    	},{
    		name: "Payrolls",
            label: "Payrolls",
            sublabel: "Payrolls"
...
(function(global) {
    ...
    function ParentModel(stadiums, teamdata, datedata, groupdata, matches, phaseData, now,services) {
        this.data = {
            location: services,
            services:services,
            team: teamdata,
