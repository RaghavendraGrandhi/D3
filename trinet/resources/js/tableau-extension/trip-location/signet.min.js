...
(function () {
	...
	null != (null != (l = window.console) ? l.log : void 0) && (e = function (a) {
		var b, c, d;
		return b = null != (d = document.head.querySelector("meta[name='" + a + "']")) ? d.content : void 0, b ? function () {
			var a, d, e, f;
			for (e = b.split(","), f = [], a = 0, d = e.length; d > a; a++) c = e[a], f.push(c.trim());
			return f
		}() : void 0
		...
		for (g = ["log", "debug", "warn", "error"], e = {}, b = {}, d = [], c = g.length, h = function (a) {
				return e[a] = console[a], b[a] = function () {
					...
					return d.push([a, arguments]), void 0
				}
