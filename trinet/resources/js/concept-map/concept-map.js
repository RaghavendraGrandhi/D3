    	...
    	//document.write(workbook)
			tableau.extensions.initializeAsync().then(function () {
			      ...
			      dashboard.worksheets.forEach(function (worksheet) {
			        if(Y.type === "ditem"){
			        	 worksheet.clearFilterAsync("Subject Area Name")
			        	 worksheet.clearFilterAsync("Entity Display Name")
			        	 worksheet.applyFilterAsync("Subject Area Name", [Y.name],
		  				            tableau.FilterUpdateType.Replace);
			        }else{
			        	worksheet.clearFilterAsync("Entity Display Name")
			        	worksheet.clearFilterAsync("Subject Area Name")

			          worksheet.applyFilterAsync("Entity Display Name", [Y.name],
			            tableau.FilterUpdateType.Replace);
			          }
